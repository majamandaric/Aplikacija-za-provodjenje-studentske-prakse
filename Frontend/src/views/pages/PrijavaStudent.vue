      ...
      <b-card header-tag="header" body-class="text-center" style="width: 600px; height:680px; margin:auto; margin-top:5px;">
        ...
        <div class="img-group">
          <div class="responsive">
            <div class="gallery1">
              <a href="http://localhost:8080/loginemployer">
        ...
        <div>
          <h6 class="natpis-h6">Prijavi se kao student</h6>
        </div>
        <form @submit.prevent="PrijavaKorisnika">
          ...
          <div class="inputi">
            <b-input-group>
              ...
              <b-form-input v-model="email" class="form-control" size="lg" type="email" placeholder="E-mail">
              </b-form-input>
            </b-input-group>
          </div>
          ...
          <div class="inputi">
            <b-input-group>
              ...
              <b-form-input v-model="password" class="form-control" size="lg" type="password" placeholder="Lozinka">
              </b-form-input>
            </b-input-group>
          </div>
        ...
        <div class="registracija-btn">
          <b-button class="registracija-btn2" @click="toRegisterStudent()" >Nemaš korisnički račun? Registriraj se</b-button>
        </div>
...
export default {
  ...
  methods: {
    ...
    toRegisterStudent() {
      this.$router.push({ name: 'RegistracijaStudent' });
    },
  },
};
</script>
